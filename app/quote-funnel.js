...
export default function QuoteFunnel({ branding }) {
                    ...
                    <div className="flex items-center gap-2 cursor-pointer min-w-0" onClick={() => goToStep(1)}>
                        {logoUrl ? (
                            ...
                            <img
                                ...
                                className="h-7 sm:h-8 w-auto max-w-[120px] object-contain flex-shrink-0"
                            />
                        ) : (
                    ...
                    {step === 1 && (
                        <div className="space-y-2.5">
                            {SERVICES.map((item) => {
                                ...
                                const showEmergencyCall = item.val === 'Active Leak / Repair';
                                return (
                                    <div
                                        key={item.val}
                                        role="button"
                                            ...
                                            <div className="min-w-0">
                                                ...
                                                {showEmergencyCall ? (
                                                    <a
                                                        ...
                                                        className="mt-1.5 inline-flex items-center gap-1.5 rounded-full border border-danger/35 bg-danger-tint px-2.5 py-1 text-[11px] sm:text-xs font-semibold text-danger hover:border-danger/50 focus:outline-none focus:ring-2 focus:ring-danger/40"
                                                        aria-label="Emergency? Call now at 555-555-0123">
